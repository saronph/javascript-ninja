...
*/
  ...
  cpfs.forEach((cpf) => {
    return console.log(formattedCpf(cleanCPF(cpf)));
  });
...
*/
  ...
  // console.log(stringMonth.match(/ju[nl]ho/g)); [nl] uma letra ou outra
...
*/
  ...
  var regex2 = /<(\w+)>([^<]+)<\/\w+>/g;
  console.log(
    string.replace(regex2, '<$1> O texto dentro da tag "$1" é "$2" </$1> \n')
  );
})();
